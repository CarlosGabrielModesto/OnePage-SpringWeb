package com.web.zn.SpringWeb.controllers;
...
import com.web.zn.SpringWeb.repository.CandidatoRepository;
import com.web.zn.SpringWeb.repository.VagaRepository;
...
public class VagaController {
	...
	@RequestMapping(value = "/cadastrarVaga", method = RequestMethod.GET) //deixar valor?**
	public String form() {
	...
	public ModelAndView listaVagas() {
		ModelAndView mv = new ModelAndView("vaga/listaVaga"); //"vaga/lista-vaga"
	...
	public ModelAndView detalhesVaga(@PathVariable("codigo") long codigo) {
		...
		ModelAndView mv = new ModelAndView("vaga/detalhesVaga"); //detalhes-vaga
	...
	public String detalhesVagaPost(@PathVariable("codigo") long codigo, @Valid Candidato candidato, BindingResult result, RedirectAttributes attributes) {
		...
		if (result.hasErrors()) {
			attributes.addFlashAttribute("mensagem", "Verifique os campos");
			return "redirect:/vaga/{codigo}"; // "/vaga/" OU "/"??
		}
	...
	@RequestMapping(value="/editar-vaga", method = RequestMethod.GET) //("/editar-vaga")
